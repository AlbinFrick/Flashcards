...
function addCard() {
    ...
    div.innerHTML = "<textarea type=\"text\" form=\"form1\" placeholder=\"Fråga\" style=\"background-color: " + cardColor +"\"></textarea>" +
        "<textarea type=\"text\" form=\"form1\" laceholder=\"Svar\" style=\"background-color: " + cardColor +"\"></textarea>";

    div.className = "cardContainer";
    var div2 = document.createElement("div");

    div2.innerHTML = "<img src=\"../Images/x.png\">";
...
function controlEmptyFields() {
    for (let i = 0; i < fullForm.length; i++) {
        if (fullForm.elements.length < 4 || !fullForm.elements[i].value) {
